          ...
          <div class="auth-inner row m-0">
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
              <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                  ...
                  <div class="mb-1">
                    <div class="d-flex justify-content-between">
                      <label class="form-label" for="login-password">Password</label><a href="/auth/forgot-password"><small>Forgot Password?</small></a>
                    </div>
                ...
                <p class="text-center mt-2"><span>New on our platform?</span><a href="/auth/register"><span>&nbsp;Create an account</span></a></p>
